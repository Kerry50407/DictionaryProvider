...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView dictListView = (ListView) findViewById(R.id.dictionary_listView);
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(this, android.R.layout.two_line_list_item, cursor, COLUMN_TO_BE_BOUND, LAYOUT_ITEMS_TO_FILL, 0);
